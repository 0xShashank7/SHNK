...
contract SHNKTest is Test {
    ...
    function test_Burn() public {
        uint amountToMint = 10 * 10 ** 18;
        vm.prank(minter);
        shank.mint(minter, amountToMint);

        // amount to burn
        uint amountToBurn = 5 * 10 ** 18;
        // minter can burn
        vm.prank(minter);
    ...
    function test_Transfer() public {
        ...
        assertEq(
            shank.balanceOf(admin),
            initialBalance - amount,
            "Admin should send tokens"
        );
